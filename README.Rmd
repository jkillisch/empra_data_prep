...
Ein wichtiger Aspekt bei der Verwendung von tidyverse Paketen ist, dass Sie regelmäßigen Änderungen unterworfen sind. Dadurch veraltet Code im tidyverse Stil schneller als Code, den Sie mit base R schreiben. Da die Empra-Analysen nur einmal mit dem erhobenen Datensatz laufen müssen, eignen sich die tidyverse Pakete sehr gut für diese Art von Analyse. Ich verwende hier die Pakete dplyr und ggplot2.
